    ...
    <Card key={post.id} className="mb-3 h-100 d-flex">
      ...
      <CardActionArea className="w-100">
        ...
        <CardContent>
         ...
         <div> <a style={{fontWeight:400,textTransform:"none",fontSize:12,color: "#555555"}} href ="#">c/{post.community.name}</a></div>
        </CardContent>
      </CardActionArea>
      ...
      <CardActions className="d-flex">
        ...
        {post.voteCount||0}  Comments
            ...
            <div className="ml-auto" style={{fontWeight:550,textTransform:"none",fontSize:13, marginBottom:3.8}}>Posted by on {post.createdAt} by <a href="#" style={{color: "#202020",fontWeight:600}}>{post.user.username}</a></div>
      </CardActions> </div>
    </Card>)}
